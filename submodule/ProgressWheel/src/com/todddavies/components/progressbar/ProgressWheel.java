...
//		canvas.drawCircle(circleBounds.centerX(), circleBounds.top, (circleBounds.centerX()-circleBounds.left)/22, barPaint);
		barPaint.setStyle(Style.STROKE);
...
//		}
		...
		if (splitText.length > 0) {
			textPaint.setColor(textColor);
			textPaint.setTextSize(textSize);
			float offset = textPaint.measureText(splitText[offsetNum]) / 2;
			canvas.drawText(splitText[offsetNum], this.getWidth() / 2 - offset,
					this.getHeight() / 2 + (textSize * (offsetNum))
			...
			if (splitText.length > 1) {
				...
				textPaint.setTextSize((textSize / 3) * 2);
					...
					offset = textPaint.measureText(splitText[offsetNum]) / 2;
					canvas.drawText(splitText[offsetNum], this.getWidth() / 2
			...
			{
				textPaint.setTextSize((textSize / 2) * 1);
				barPaint.setStyle(Style.FILL);
				//canvas.drawCircle(circleBounds.centerX(), this.getHeight() / 2	+ (textSize * (offsetNum))- ((splitText.length - 1) * (textSize / 2)) + this.getWidth()/10, (int)(textSize*1)+10, barPaint);
				offset = textPaint.measureText(splitText[offsetNum]) / 2;
				canvas.drawText(splitText[offsetNum], this.getWidth() / 2
						- offset, this.getHeight() / 2
						+ (textSize * (offsetNum))
			...
			if(splitText.length > 3)
			{
				...
				canvas.drawText(splitText[offsetNum], this.getWidth() / 2
						- offset, this.getHeight() / 2
						+ (textSize * (offsetNum))
						- ((splitText.length - 1) * (textSize / 2)) + this.getWidth()/15, textPaint);
				barPaint.setStyle(Style.STROKE);
				offsetNum++;
			}
